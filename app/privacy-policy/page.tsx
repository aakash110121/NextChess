...
import HeroBgImgPrivacy from '@/public/images/privacy-banner.jpg';

export const metadata: Metadata = {
  title: 'Privacy Policy | Squsts',
}
...
regardless of whether they appear in singular or in plural.
    ...
    <ul>
       ...
       <li>
          ...
          refers to Squsts, accessible from 
          <a href="mailto:http://squsts.com">http://squsts.com
          </a>
       </li>
       <li>
          <strong>
 ...
 <div className="privacy-wrap">
    ...
    <p>
       ...
       collect personally identifiable information from anyone under the age of 13. If You are
 ...
 <div className="privacy-wrap">
    ...
    <ul>
       <li>
          ...
          <a href="mailto:info@squsts.com"> info@squsts.com</a>
       </li>
    </ul>
 </div>
 </div>
