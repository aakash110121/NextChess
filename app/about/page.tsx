    ...
    <>
      ...
      <section className="czjaw">
        ...
        <div className="cbng2 cgk3d c2ysc c4shy cgjq2 codcr">
          ...
          alt="About"
          />
          <div className="c6z3b clgvu ckfkh cgk3d c2ysc" aria-hidden="true"></div>
        </div>
          ...
          <div className="cdoe6 c8lmj ccem0 c09hn">
            <div className="c5ymx">
              <div className="cw3my cxdxt czjaw cnc7y">
                <div className="czak8 cn6x8 czjaw" data-aos="fade-up">
                  <img
                    className="c3f8f"
                ...
                <div className="cgk3d" data-aos="fade-down">
                  <h1 className="cps50 cbhe1 c41dw">
                    The magic of chess, beauty and <span className="text-teal-500">complexity</span>
                  </h1>
                </div>
                <div className="ci7tf c2mtv cgk3d c35ck cfolu coy3i cgu39" aria-hidden="true"></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section>
        <div className="czd2q c92f3 cmhb9 c1plj">
          <div className="cdoe6 cafls ccem0 chfiq">

            {/* Section header */}
            <div className="c5ymx calbx cdoe6 cmhb9 ccem0">
              <h2 className="cps50 cyb9k cdjn8">Who We Are</h2>
              <p className="text-gray-600 c0atf czz36">
                Welcome to Squsts, where tradition meets innovation in the timeless game of chess. We are a passionate team of chess enthusiasts, designers, and developers dedicated to enhancing the chess experience for players of all levels. Our mission is to create a dynamic and engaging platform that not only honors the rich history of chess but also introduces exciting new elements to the game.
              </p>
            </div>

            {/* Items */}
            <div className="cufz0 c6mcl cv9a4 cn6x8 chwi0 c2k38 cmhb9 c5ws9 c5v0a c74as">

              {/* 1st item */}
              <div className="cxdxt czjaw c54sb cnc7y">
                <div aria-hidden="true" className="c6z3b c0pm6 c1qo9 ckm3h ceejv ckfkh cs90m cgk3d chb9f cfrwd czrj7" style={{ width: 'calc(100% - 96px)', left: 'calc(50% + 64px)', top: '40px' }}></div>
                <div className="czjaw cyws0 cevvc c6y2l">
                  <div className="cgplj cssaq cpz4m cq5qk cgk3d c2ysc codcr" aria-hidden="true"></div>
                  <svg className="text-teal-500 c4u31 cevvc c6y2l" viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="cf26p cf4hw czsvu">Founded in 2022</div>
              </div>
              ...
              <div className="cxdxt czjaw c54sb cnc7y">
                <div aria-hidden="true" className="c6z3b c0pm6 c1qo9 ckm3h ceejv ckfkh cs90m cgk3d chb9f cfrwd czrj7" style={{ width: 'calc(100% - 96px)', left: 'calc(50% + 64px)', top: '40px' }}></div>
                <div className="czjaw cyws0 cevvc c6y2l">
                  <div className="cgplj cykzy cpz4m cq5qk cgk3d c2ysc codcr" aria-hidden="true"></div>
                  <svg className="text-indigo-500 c4u31 cevvc c6y2l" viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg">
      ...
      <section>
        <div className="czd2q c92f3 cmhb9 c1plj">
          <div className="cq8p6 cvde3 c1xxg cnqgv cxbax">
            ...
            {/* Section header */}
            <div className="c5ymx calbx cdoe6 cmhb9 ccem0">
              <h2 className="cps50 cyb9k cdjn8">What We Offer</h2>
              <p className="text-gray-600 c0atf czz36">
                We offer a variety of features designed to elevate your chess experience:
              </p>
            </div>

            {/* Section content */}
            <div>
              <div className="cn6x8 cnc7y">
                
                {/* 2020's articles */}
                {year === '2020' && (
                  <div className="c2h4q">
                    <div className="co9sm cszww c5v0a c74as">
                      <Article
                        title="Classic Chess"
                    ...
                    {/*  <Article
                      ...
                      <Article
                        ...
                        description="Access tutorials, practice modes, and in-game analytics to improve your skills and strategy."
                      />
                    </div>
                  </div>
                )}
                ...
                {year === '2016' && (
                  <div className="c2h4q">
                    <div className="co9sm cbv7r c74as">
                      <Article
                        title="Mobile builder enabled"
                        description="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est."
                      />
                      <Article
                        title="Series B fundraising"
                        description="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt."
      ...
      <section>
        <div className="czd2q c92f3 cmhb9 c1plj">
          ...
          <div className="c5ymx calbx czjaw cmhb9">
            
            {/* CTA header */}
            <h3 className="cps50 crnbw csrqa cm36t">
            Experience the Future of Chess! 
            </h3>
            <p className="cn4vl czz36">
            Whether you&#39;re a seasoned chess player or just starting out, Squsts is the perfect place to explore the game in new and exciting ways. Join us on this journey, and let&#39;s make chess more thrilling, engaging, and accessible than ever before.
            </p>

            {/* CTA button */}
            <div className="cw3my c2bi2 cnc7y">
            <a className="text-white bg-teal-500 cvy08 ctr9b" href="#0">
              Send us a message
            </a>
            </div>
