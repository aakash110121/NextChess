...
const MobileSiderbar = ({toggleComponentVisibility, lout}: any) => {
        ...
        <div>
          ...
          >
            ...
            <div className="fixed inset-0 z-[80] flex">
              <div
                className="relative flex w-full max-w-xs flex-1 flex-col  translate-x-0"
                id="headlessui-dialog-panel-:rf:"
                data-headlessui-state="open"
              >
                <div className="absolute top-0 right-0 -mr-8 pt-2 opacity-100">
                  <button
                    type="button"
                    className="ml-1 flex h-10 w-10 items-center justify-center focus:outline-none focus:ring-2 hover:ring-2 focus:ring-inset focus:ring-white"
                    tabIndex={0}
                ...
                <SidebarLeftMobile lout={lout} isMobileView={true}/>
              </div>
