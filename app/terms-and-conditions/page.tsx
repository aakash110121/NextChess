...
conditions stated on this page.
    ...
    <p>
       ...
       above terminology or other words in the singular, plural, capitalization and/or he/she
 ...
 <div className="privacy-wrap">
    ...
    <p>
       Unless otherwise stated, Squsts and/or its licensors own the intellectual property
       rights for all material on www.squsts.com. All intellectual property rights are
       reserved. You may access this from www.squsts.com for your own personal use
    ...
    <ul>
       <li>
          Republish material from www.squsts.com
       </li>
       <li>
          Sell, rent or sub-license material from www.squsts.com
       </li>
       <li>
          Reproduce, duplicate or copy material from www.squsts.com
       </li>
       <li>
          Redistribute content from www.squsts.com
       </li>
    </ul>
    <p>
    ...
    <p>
       ...
       and information in certain areas of the website. Squsts does not filter, edit, publish or
       review Comments prior to their presence on the website. Comments do not reflect
       the views and opinions of Squsts,its agents and/or affiliates. Comments reflect the
       views and opinions of the person who post their views and opinions. To the extent
       permitted by applicable laws, Squsts shall not be liable for the Comments or for any
    ...
    <p>
       Squsts reserves the right to monitor all Comments and to remove any Comments
    ...
    <p>
       You hereby grant Squsts a non-exclusive license to use, reproduce, edit and authorize
 ...
 <div className="privacy-wrap">
    ...
    <ul>
       ...
       <li>
          ...
          they hyperlink to the Websites of other listed businesses; 
       </li>
       <li>
    ...
    <ul>
       ...
       <li>
          the benefit to us
          from the visibility of the hyperlink compensates the absence of Squsts; 
       </li>
       <li>
          the
    ...
    <p>
       ...
       linking to our website, you must inform us by sending an e-mail to Squsts. Please
       include your name, your organization name, contact information as well as the URL
